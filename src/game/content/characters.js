...
export const CHARACTERS = Object.freeze([
  Object.freeze({
    ...
    portraitAsset: 'player-nova.png',
    sheetAsset: 'player-nova-sheet-v2.webp',
    nativeFacing: 1,
    accent: 0x6ef4ff,
  ...
  Object.freeze({
    ...
    portraitAsset: 'player-vex.png',
    sheetAsset: 'player-vex-sheet-v2.webp',
    nativeFacing: -1,
    accent: 0xffad72,
  ...
  Object.freeze({
    ...
    portraitAsset: 'player-lucia-portrait.png',
    sheetAsset: 'player-lucia-sheet-v2.webp',
    nativeFacing: -1,
    accent: 0x5ff3e2,
  ...
  Object.freeze({
    ...
    portraitAsset: 'player-luna-portrait.png',
    sheetAsset: 'player-luna-sheet-v2.webp',
    nativeFacing: -1,
    accent: 0xc79aff,
  ...
  Object.freeze({
    ...
    portraitAsset: 'player-juan-portrait.png',
    sheetAsset: 'player-juan-sheet-v3.webp',
    nativeFacing: 1,
    accent: 0x55e0d0,
  ...
  Object.freeze({
    ...
    portraitAsset: 'player-juanjo-portrait.png',
    sheetAsset: 'player-juanjo-sheet-v1.webp',
    nativeFacing: 1,
    accent: 0xff8298,
